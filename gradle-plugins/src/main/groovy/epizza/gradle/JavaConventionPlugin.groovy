...
class JavaConventionPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        configureJavaCodeStyleInEclipse(project)
    }
    ...
    private void configureJavaCodeStyleInEclipse(Project project) {
        ...
        project.eclipse.jdt.file.withProperties { Properties properties ->
